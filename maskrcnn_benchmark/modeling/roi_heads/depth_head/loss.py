...
class MaskRCNNDepthLossComputation(object):
    ...
    def match_targets_to_proposals(self, proposal, target):
        ...
        target = target.copy_with_fields(["labels", "masks", "depths"], skip_missing=True)
...
class MaskRCNNDepthLRLossComputation(MaskRCNNDepthLossComputation):
    def __call__(self, proposals, depth_logits, depth_logits_lr, targets):
        """
        Arguments:
            proposals (list[BoxList])
            depth_logits (Tensor)
